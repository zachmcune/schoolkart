  ...
  .then(function () {
    return fetch("http://127.0.0.1:" + PORT + "/").then(function (r) {
      return r.text().then(function (html) {
        ...
        assert(html.indexOf('SK_BUILD = "mp50"') !== -1, "cache bump mp50");
        ...
        return fetch("http://127.0.0.1:" + PORT + "/manifest.json")
          ...
          .then(function (sr) {
            return sr.text().then(function (sw) {
              ...
              assert(sw.indexOf('BUILD = "mp50"') !== -1, "SW build matches cache");
            ...
            return Promise.all([
              fetch("http://127.0.0.1:" + PORT + "/js/game.js").then(function (r) {
                return r.text().then(function (js) {
                  ...
                  assert(js.indexOf("var turn = -steer * 0.42") !== -1, "open front wheels yaw with A/D");
