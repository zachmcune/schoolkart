            ...
            return Promise.all([
              fetch("http://127.0.0.1:" + PORT + "/js/game.js").then(function (r) {
                return r.text().then(function (js) {
                  ...
                  assert(js.indexOf("function paintPitRibbon") !== -1 && js.indexOf("function buildCampusPitPath") !== -1 && js.indexOf("function fillPitGore") !== -1, "pit lane is a real track that curves in and out");
                  ...
                  assert(js.indexOf("gyroCenter += d * 0.08") === -1, "tilt rest does not chase a slow lean");
                  assert(js.indexOf("var TILT_LEVEL = 2.5") !== -1, "level phone is straight");
